...
% normalize the cooccurence matrix and readjust the angles
...
% the intersection angle between 0 and 17 should be 1 instead of 17

all_contrast(find(all_contrast>9))=18-all_contrast(find(all_contrast>9));
